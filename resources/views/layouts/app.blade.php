    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">Lama Abunadi</span>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" click="this.style.color='white'; this.style.backgroundColor='#ffc107';" href="#experience">Experience</a></li>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        Lama
                        <span class="text-primary">Abunadi</span>
                    </h1>
...
own initiative. I am able to work well under pressure and adhere to strict deadlines.</p>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">King Faisal University</h3>
                            <div class="subheading mb-3">College of Computer Science and Information Technology</div>
                            <div>Bachelor in Computer Science & IT</div>
                            <p>GPA: 4.84</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">September 2017 - April 2021</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                        <div class="flex-grow-1">
                            <h3 class="mb-0" style="color:#ffc107;">On First Dean List</h3>
                        </div>
                ...
                <div class="resume-section-content">
                    ...
                    <ul class="fa-ul mb-0">
                        <li>
                            ...
                            English Certification - The International English Language Testing System (IELTS)
                        </li>                    
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            Full Stack Developer - One Million Arab Coder Initiative
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            Data Analyst - One Million Arab Coder Initiative
                        </li>                        
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
						...
						<div class="row justify-content-center">
							<div class="col-lg-8 mb-5">
								<div class="row">
					        		...
					        		<div class="text">
						            <p><span>Address:</span> Saudi Araba / Eastern Region</p>
						          </div>
					          </div>
									</div>
									<div class="col-md-4">
					        		...
					        		<div class="text">
						            <p><span>Phone:</span>+966509508875</p>
						            </div>
					                </div>
									</div>
					        		...
					        		<div class="text">
						            <p><span>Email:</span> <a href="Lama199703@gmail.com">Lama199703@gmail.com</a></p>
						          </div>
					          </div>
									</div>
								</div>
